...
@Getter
@Setter
@Schema(description = "新增场景参数请求")
public class SceneParamCreateDTO {
    ...
    @Schema(description = "排序号，未传时使用当前场景最大排序号加1", example = "1")
    private Integer sortOrder;

    @Schema(description = "是否必填，0否，1是；未传时默认0", example = "0")
